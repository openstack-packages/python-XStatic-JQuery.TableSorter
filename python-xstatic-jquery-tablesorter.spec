...
Version:        XXX
Release:        1%{?dist}
Summary:        JQuery.Tablesorter JavaScript library packaged for setuptools

License:        MIT
URL:            http://git.openstack.org/cgit/stackforge/xstatic-jquery.tablesorter/
...
%description
JQuery.Tablesorter javascript library packaged for
...
%{python_sitelib}/xstatic/pkg/jquery_tablesorter
